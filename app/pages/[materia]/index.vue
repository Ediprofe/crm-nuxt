    ...
    <header class="bg-white border-b border-gray-200">
      <div class="container mx-auto px-4 py-6">
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            <h1 class="text-4xl font-bold text-gray-900">{{ configMateria?.nombre }}</h1>
    ...
    <main class="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div v-if="unidades && unidades.length > 0" class="space-y-4">
        <NuxtLink
          ...
          class="block bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-200 border border-gray-200 hover:border-blue-300"
        >
          <div class="p-6">
            <div class="flex items-start justify-between">
              <div class="flex-1">
                ...
                <p v-if="unidad.description" class="text-gray-600 ml-11 mt-1">
                  {{ unidad.description }}
                </p>
              </div>
      ...
      <div v-else class="text-center py-12">
        ...
        <h3 class="text-xl font-semibold text-gray-700 mb-2">No hay unidades disponibles</h3>
        <p class="text-gray-500 mb-6">Aún no se han agregado unidades para esta materia.</p>
        <NuxtLink 
          to="/" 
