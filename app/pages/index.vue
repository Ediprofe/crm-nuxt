  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    ...
    <header class="bg-white shadow-sm">
      <div class="container mx-auto px-4 py-8">
        <h1 class="text-4xl font-bold text-gray-900">EdiProfe.com</h1>
        <p class="mt-2 text-lg text-gray-600">Plataforma educativa interactiva</p>
      </div>
    </header>
    ...
    <main class="container mx-auto px-4 py-12">
      <div class="mb-8">
        <h2 class="text-3xl font-bold text-gray-900 mb-2">Materias Disponibles</h2>
        <p class="text-gray-600">Selecciona una materia para comenzar a estudiar</p>
      </div>
